...
void UART2_rxtx_init (void)
{
  ...
  /*3*/    GPIOA->AFR[0]  |= (1<<8);
  	  	...
  	  	// 2. Set PA3 Mode to work in Alternate Mode
  	  	//* 3. SET PA3 Alternative function type to UART Tx (AF7 ) in AFRL register of GPIOx */
  	  	GPIOA->MODER |= (1<<7);
  	  	GPIOA->MODER &=~(1<<6);
